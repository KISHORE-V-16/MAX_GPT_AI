...
import Login_Auth from '../Auth/Login_Auth';
    ...
    <div className='container flex flex-row w-[300rem] pr-[76.7rem] overflow-hidden bg-blend-multiply h-[37.34rem]'>
          ...
          <div className="sub-cont-1 backdrop-blur-3xl bg-gradient-to-r from-teal-400  to-indigo-500 w-[50rem] h-[37.50rem] shadow-[0px_0px_40px_-0px] shadow-blue-800 rounded-r-[30px]">
              ...
              <div className="head-cont w-max h-[15rem] flex flex-row items-center justify-start pl-[20px] gap-5 ">
               ...
               <footer>
                  <div className="circle-cont-1 mt-[200px] ml-[-50px] w-[10rem] h-[5rem]">
                        <span className='w-10rem h-5rem rounded-[150px] bg-gradient-to-r from-blue-700  to-gray-950 relative text-gray-950 p-[100px] bg-slate-950 shadow-slate-300 shadow-[0 0 -40 10]'>
                            dds
                        </span>
